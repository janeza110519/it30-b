 ...
 -- students SQL #2: select students in asc order;
 SELECT * FROM students
...
SELECT student_first_name,
       student_last_name
FROM students
ORDER BY student_id = 1
LIMIT 1;

-- student SQL #10 - update student name a student base on id
UPDATE students
SET student_first_name= 'Janeza',
    student_last_name='Malaya'
WHERE student_id = 1;